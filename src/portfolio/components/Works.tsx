...
export const Works = ({language = 'en'}: Props) => {
    ...
    const [work, setWork] = useState('work4');

    return (
        <div className="row">
            <div className="col-2 animaTop">
                <div className="links">
                    <button className={`work ${ work === 'work4' && 'active'}`} onClick={() => setWork('work4')}>Geograma</button>
            ...
            <div className="col-10 animaTop">
                < SingleWork work={work} showIf='work1' title='El Relator S.L' date='2020-2021' >
                ...
                < SingleWork work={work} showIf='work2' title='Freelance' date='2020-2022' >
                ...
                < SingleWork work={work} showIf='work3' title='Noddus' date='2021-2022' >
                ...
                < SingleWork work={work} showIf='work4' title='Geograma' date={`2022-${language === 'en' ? 'Actually' : 'Actualmente'}`} >
                      <p> <i className='bx bx-caret-right'></i> { language === 'en' ? 'Gis projects with different functionalities, with the ability to adapt to customer needs.' : 'Proyectos Gis con diferentes funcionalidades, con capacidad de adapatarse a las necesidades del cliente.'}</p>
                      <p> <i className='bx bx-caret-right'></i> { language === 'en' ? 'Write modern, performant, maintainable code for a diverse array of client and internal projects.' : 'Crear códigos modernos, optimizados y mantenibles para diversos clientes.'}</p>
                      <p> <i className='bx bx-caret-right'></i> { language === 'en' ? 'Work with a variety of different languages, platforms, frameworks, and content management systems such as JavaScript, TypeScript, React, Angular, NodeJs, Express, Docker, Google analytics, GIS libraries...' : 'Trabajar con variedad de lenguajes, plataformas y frameworks diferentes como Javascript, Typescript, React, Angular, NodeJs, Express, Docker, Google analytics, librerías GIS .'} </p>
                      <p> <i className='bx bx-caret-right'></i> { language === 'en' ? 'National and international projects for different clients such as Tom Tom, Bilbao Provincial Council, Sevilla Provincial Council, VIOOH  ...' : 'Proyectos nacionales e internacionales para diferentes clientes como Tom Tom, La diputación de Bilbao, La diputación de Sevilla, VIOOH...'}</p>
                </SingleWork>
            </div>
        </div>
    )
